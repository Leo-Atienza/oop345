...
namespace seneca {
	...
	public:
		...
		int getAttackAmnt() const override {
			...
			return static_cast<int>(1.3 * static_cast<double>(m_baseAttack));
		}

		int getDefenseAmnt() const override {
			
			return static_cast<int>(1.2 * static_cast<double>(m_baseDefense));
		...
		void takeDamage(int dmg) override {
			...
			CharacterTpl<SuperHealth>::takeDamage(reduced);
		}
	};
}
